...
class AbsensiPegawaiPolicy
{
    ...
    {
        return $user->can('view-any AbsensiPegawai');
    }
    ...
    {
        return $user->can('view AbsensiPegawai');
    }
    ...
    {
        return $user->can('create AbsensiPegawai');
    }
    ...
    {
        return $user->can('update AbsensiPegawai');
    }
    ...
    {
        return $user->can('delete AbsensiPegawai');
    }
    ...
    {
        return $user->can('restore AbsensiPegawai');
    }
    ...
    {
        return $user->can('force-delete AbsensiPegawai');
    }
}
