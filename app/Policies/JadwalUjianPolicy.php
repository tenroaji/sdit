...
class JadwalUjianPolicy
{
    ...
    {
        return $user->can('view-any JadwalUjian');
    }
    ...
    {
        return $user->can('view JadwalUjian');
    }
    ...
    {
        return $user->can('create JadwalUjian');
    }
    ...
    {
        return $user->can('update JadwalUjian');
    }
    ...
    {
        return $user->can('delete JadwalUjian');
    }
    ...
    {
        return $user->can('restore JadwalUjian');
    }
    ...
    {
        return $user->can('force-delete JadwalUjian');
    }
}
