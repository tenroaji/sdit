...
class KelasSantriPolicy
{
    ...
    {
        return $user->can('view-any KelasSantri');
    }
    ...
    {
        return $user->can('view KelasSantri');
    }
    ...
    {
        return $user->can('create KelasSantri');
    }
    ...
    {
        return $user->can('update KelasSantri');
    }
    ...
    {
        return $user->can('delete KelasSantri');
    }
    ...
    {
        return $user->can('restore KelasSantri');
    }
    ...
    {
        return $user->can('force-delete KelasSantri');
    }
}
